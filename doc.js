/**
 * Created by puxiang on 2017/12/20.
 */
/**
...
export default class Pdf extends Component {
  ...
  _prepareFile = source => {
    if (source.uri) {
      ...
      const cacheFile = RNFetchBlob.fs.dirs.CacheDir + '/' + SHA1(uri) + '.doc';
  ...
  _downloadFile = (source, cacheFile) => {
    ...
    this.lastRNBFTask
      .then(res => {
        ...
        this.setState({isDownloaded: true, progress: 1},()=>{
          return cacheFile;
        })
      }).then(file=>{
